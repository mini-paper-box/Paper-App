...
if __name__ == "__main__":
    ...
    TIER_START_OFFSET = 8  # Change this value to adjust tier calculation start
    ...
    schedules_to_run = {
        ...
        "Elitron_Strip": (msf, [13,9], max_days, elitron+1, 1),
        "Elitron_Strip_Glue": (msf, [13,9,15], max_days, elitron+2, 1),
        ...
        "Nozomi_Elitron_Strip": (msf, [6,13,9], max_days, nozomi+1, 1),
        "Nozomi_Elitron_Strip_Glue": (msf, [6,13,9,15], max_days, nozomi+1, 1)
    }
    ...
    scheduler.send_email(
        ...
        "caitlin@whitebird.ca;Kamaldeep.k@whitebird.ca;william@whitebird.ca;luke.t@moyydesign.com",
